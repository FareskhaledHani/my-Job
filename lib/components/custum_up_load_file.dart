...
class CustomUpLoadFileContainer extends StatelessWidget {
  const CustomUpLoadFileContainer({
    required this.onTap,
    Key? key, required this.onTapText,
  }) : super(key: key);
            ...
            children: [
              const SizedBox(height: 20,),
               CircleAvatar(
                ...
                maxRadius: 30,
                child: IconButton(onPressed: (){}, icon: const Icon(FontAwesomeIcons.fileArrowUp,size: 30,),)
              ),
              TextButton(onPressed: onTapText, child: Text(S.of(context).UploadCV)),
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Icon(FontAwesomeIcons.arrowUpFromBracket,color:Color(0xff3366FF),size: 15, ),
